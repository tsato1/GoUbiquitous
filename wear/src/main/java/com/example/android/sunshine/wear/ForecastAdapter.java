...
//            }
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        int weatherId = mCursor.getInt(MainActivity.COL_WEATHER_CONDITION_ID);
        int defaultImage;
        ...
        long dateInMillis = mCursor.getLong(MainActivity.COL_WEATHER_DATE);
        ...
        double high = mCursor.getDouble(MainActivity.COL_WEATHER_MAX_TEMP);
        ...
        double low = mCursor.getDouble(MainActivity.COL_WEATHER_MIN_TEMP);
